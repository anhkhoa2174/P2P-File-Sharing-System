...
class peer:
    ...
    def update_client_list(self, tracker_socket, server_host, server_port):
    ...
    def connect_to_tracker(self, server_host, server_port):
        ...
        self.update_client_list(tracker_socket, server_host, server_port)
    ...
    def disconnect_from_tracker(self, tracker_socket, server_host, server_port):
        header = "disconnect:"
        message = header.encode("utf-8")
        tracker_socket.sendall(message)
...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            elif command == "disconnect_from_tracker":
                my_peer.disconnect_from_tracker(tracker_socket, server_host, server_port)
            elif command == "list_clients":
                my_peer.list_clients()
            elif command == "update_client_list":
                my_peer.update_client_list(tracker_socket, server_host, server_port)
