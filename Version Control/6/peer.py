...
class peer:
    ...
    def update_client_list(self, tracker_socket):
        ...
        tracker_socket.sendall(command.encode("utf-8"))
        time.sleep(1)
    ...
    def exit(self, tracker_socket):
        command = "disconnect"
        tracker_socket.send(command.encode("utf-8"))
        for conn in self.connected_client_conn_list:
    ...
    try:
        ...
        while True:
            ...
            if command == "test":
                ...
                # IMPLEMENT: disconnect_from_tracker()
                # IMPLEMENT: disconnect_from_all_peers()
